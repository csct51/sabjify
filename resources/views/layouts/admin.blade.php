...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-stone-100 text-stone-900 antialiased min-h-screen">
        <div class="flex min-h-screen">
            <aside class="hidden lg:flex flex-col w-64 bg-stone-900 text-stone-300 shrink-0">
                ...
                <nav class="flex-1 py-4 px-3 space-y-1 text-sm font-medium">
                    @php
                        $items = [
                ...
                <header class="bg-white border-b border-stone-200 h-16 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-30">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="flex items-center justify-center w-9 h-9 rounded-full bg-brand-100 text-brand-700 font-semibold text-sm">{{ auth()->user()->initials() }}</span>
