        ...
        <div class="bg-white rounded-2xl border border-stone-200 p-6">
            ...
            <form wire:submit="save" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea wire:model="description" rows="3" placeholder="Short description of the recipe..." class="w-full rounded-xl border border-stone-300 px-3 py-2.5 text-sm outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100"></textarea>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        @if ($recipe?->imageUrl())
                            <img src="{{ str_replace('/storage/', '/public/storage/', $recipe->imageUrl()) }}" alt="Current recipe image" class="w-16 h-16 rounded-xl object-cover border border-stone-200">
                        @endif
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button type="submit" wire:loading.attr="disabled" wire:target="save" class="inline-flex items-center gap-2 rounded-xl bg-brand-600 hover:bg-brand-700 text-white px-6 py-2.5 text-sm font-semibold transition disabled:opacity-70">
                        ...
                        <span wire:loading.remove wire:target="save">{{ $recipe ? 'Save Changes' : 'Create Recipe' }}</span>
                        <span wire:loading wire:target="save">{{ $recipe ? 'Saving...' : 'Creating...' }}</span>
                    </button>
                </div>
            </form>
        </div>
