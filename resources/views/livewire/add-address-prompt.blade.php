                    ...
                    <form wire:submit="saveAddress" class="mt-4 space-y-3">
                        ...
                        <div class="grid sm:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input id="city" type="text" wire:model="city" class="w-full rounded-xl border border-stone-300 px-3 py-2.5 text-sm outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100" />
                        ...
                        <div class="grid sm:grid-cols-2 gap-3">
                            <div>
                                ...
                                <input id="state" type="text" wire:model="state" class="w-full rounded-xl border border-stone-300 px-3 py-2.5 text-sm outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100" />
                            ...
                            <div>
                                ...
                                <input id="pincode" type="text" wire:model="pincode" inputmode="numeric" maxlength="6" class="w-full rounded-xl border border-stone-300 px-3 py-2.5 text-sm outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-100" />
