<div>
    <section class="relative bg-brand-600 text-white overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 grid lg:grid-cols-2 gap-8 items-center">
            <div>
                <span class="inline-flex items-center gap-1.5 bg-white/15 rounded-full px-3 py-1 text-xs font-medium"><i data-lucide="leaf" class="w-3.5 h-3.5"></i> 100% Farm Fresh</span>
