        ...
        <div class="grid grid-cols-3 lg:grid-cols-4 gap-4" data-reveal>
            ...
            @empty
                <div class="col-span-full text-center py-20">
                    <span class="inline-flex items-center justify-center w-16 h-16 mx-auto rounded-2xl bg-brand-50 text-brand-600"><i data-lucide="layout-grid" class="w-8 h-8"></i></span>
                    <h3 class="mt-4 text-lg font-semibold text-stone-900">No categories found</h3>
                    <p class="text-sm text-stone-500 mt-1">We're organizing our shelves. Please check back soon.</p>
                </div>
            @endforelse
        </div>
